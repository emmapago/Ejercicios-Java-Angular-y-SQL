...
public class VentanaBuscarCientifico {
...
import Backend.model.service.CientificoServ;
...
public class VentanaBuscarCientifico extends JFrame implements ActionListener {
				...
				public void actionPerformed(ActionEvent e) {
					if (e.getSource() == botonGuardar) {
						try {
							Persona miCientifico = new Cientifico();
				...
				private void muestraCientifico(Cientifico miCientifico) {
					textDNI.setDNI(miCientifico.getDNICientifico());
					textNomApels.setNomApels(miCientifico.getNomApelsCientifico() + "");
				...
				public void habilita(boolean DNI, boolean NomApels, boolean bBuscar,

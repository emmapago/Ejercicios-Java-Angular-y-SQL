package mavenEjercicio3;
	...
	public class VentanaPrincipalAsignadoA extends JFrame implements ActionListener{
		 ...
		 */
		public VentanaPrincipalAsignadoA() {
		...
		public void actionPerformed(ActionEvent e) {
			if (e.getSource()==botonRegistrar) {
				asignadoAController.mostrarVentanaRegistro();			
			}
			if (e.getSource()==botonBuscar) {
				asignadoAController.mostrarVentanaConsulta();			
			}
		}
	}

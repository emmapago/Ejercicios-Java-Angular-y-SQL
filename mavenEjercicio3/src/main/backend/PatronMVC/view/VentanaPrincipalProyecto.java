...
public class VentanaPrincipalProyecto extends JFrame implements ActionListener{
		
		private static final long serialVersionUID = 1L;
		
		private ProyectoController proyectoController; //objeto proyectoController que permite la relacion entre esta clase y la clase PersonaController
		...
		public void setCoordinador(ProyectoController proyectoController) {
			thisproyectoController=proyectoController;
		}

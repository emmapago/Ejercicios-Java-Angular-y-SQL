...
public class empleados {
	...
	public static void createTable(String db, String name) {
		try {
			...
			String Query = "CREATE TABLE " + name + ""
					+ "(DNI VARCHAR (8) PRIMARY KEY, Nombre VARCHAR(100), Apellidos VARCHAR (255), Departamento INT, FOREIGN KEY (Departamento) REFERENCES Departamentos(Codigo))";
	...
	public static void insertData(String db, String table_name, String name, String Apellidos, int Departamento) {
		try {
			String Querydb = "USE " + db + ";";
			Statement stdb = conector.conexion.createStatement();
			stdb.executeUpdate(Querydb);

			String Query = "INSERT INTO " + table_name + " (Nombre, Apellidos, Departamento) VALUE(" + "\"" + name

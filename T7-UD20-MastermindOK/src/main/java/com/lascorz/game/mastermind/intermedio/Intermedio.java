...
package com.lascorz.game.mastermind.intermedio;
...
import com.lascorz.game.mastermind.colorintermedio.Colors;
...
public class Intermedio extends JFrame {
	...
	public static Intermedio intermedio;
	...
	public Intermedio() {
		...
		layeredPane.setBounds(24, 452, 273, 62);
		...
		textField_89.setBounds(218, 11, 42, 38);
		...
		textField_12.setBounds(243, 41, 42, 38);
		contentPane.add(textField_12);
		
		textField_13 = new JTextField();
		textField_13.setEditable(false);
		textField_13.setColumns(10);
		textField_13.setBounds(35, 86, 42, 38);
		contentPane.add(textField_13);
		
		textField_14 = new JTextField();
		textField_14.setEditable(false);
		textField_14.setColumns(10);
		textField_14.setBounds(87, 86, 42, 38);
		contentPane.add(textField_14);
		
		textField_15 = new JTextField();
		textField_15.setEditable(false);
		textField_15.setColumns(10);
		textField_15.setBounds(139, 86, 42, 38);
		...
		textField_16.setBounds(191, 86, 42, 38);
		contentPane.add(textField_16);
		
		textField_17 = new JTextField();
		textField_17.setEditable(false);
		textField_17.setColumns(10);
		textField_17.setBounds(243, 86, 42, 38);
		contentPane.add(textField_17);
		
		textField_18 = new JTextField();
		textField_18.setEditable(false);
		textField_18.setColumns(10);
		textField_18.setBounds(35, 135, 42, 38);
		contentPane.add(textField_18);
		
		textField_19 = new JTextField();
		textField_19.setEditable(false);
		textField_19.setColumns(10);
		textField_19.setBounds(87, 135, 42, 38);
		contentPane.add(textField_19);
		
		textField_20 = new JTextField();
		textField_20.setEditable(false);
		textField_20.setColumns(10);
		textField_20.setBounds(139, 135, 42, 38);
		contentPane.add(textField_20);
		
		textField_21 = new JTextField();
		textField_21.setEditable(false);
		textField_21.setColumns(10);
		textField_21.setBounds(191, 135, 42, 38);
		contentPane.add(textField_21);
		
		textField_22 = new JTextField();
		textField_22.setEditable(false);
		textField_22.setColumns(10);
		textField_22.setBounds(243, 135, 42, 38);
		contentPane.add(textField_22);
		
		textField_23 = new JTextField();
		textField_23.setEditable(false);
		textField_23.setColumns(10);
		textField_23.setBounds(35, 184, 42, 38);
		contentPane.add(textField_23);
		
		textField_24 = new JTextField();
		textField_24.setEditable(false);
		textField_24.setColumns(10);
		textField_24.setBounds(87, 184, 42, 38);
		contentPane.add(textField_24);
		
		textField_25 = new JTextField();
		textField_25.setEditable(false);
		textField_25.setColumns(10);
		textField_25.setBounds(139, 184, 42, 38);
		contentPane.add(textField_25);
		
		textField_26 = new JTextField();
		textField_26.setEditable(false);
		textField_26.setColumns(10);
		textField_26.setBounds(191, 184, 42, 38);
		contentPane.add(textField_26);
		
		textField_27 = new JTextField();
		textField_27.setEditable(false);
		textField_27.setColumns(10);
		textField_27.setBounds(243, 184, 42, 38);
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
            	...
            	if(intentos==0) {
            		...
            		if(textField_48.getBackground().equals(Color.black) && textField_49.getBackground().equals(Color.black) && textField_50.getBackground().equals(Color.black) && textField_51.getBackground().equals(Color.black) && textField_52.getBackground().equals(Color.black)) {
            	...
            	//ifelse columna 2
	            	...
	            	if(textField_13.getBackground().equals(textField_4.getBackground())) {
	            		textField_53.setBackground(Color.black);
	            	}else {
	            		textField_53.setBackground(Color.white);
	            	}
	            	if(textField_14.getBackground().equals(textField_5.getBackground())) {
	            		textField_54.setBackground(Color.black);
	            	}else {
	            		textField_54.setBackground(Color.white);
	            	}
	            	if(textField_15.getBackground().equals(textField_6.getBackground())) {
	            		textField_55.setBackground(Color.black);
	            	}else {
	            		textField_55.setBackground(Color.white);
	            	}
	            	if(textField_16.getBackground().equals(textField_7.getBackground())) {
	            	...
	            	if(textField_53.getBackground().equals(Color.black) && textField_54.getBackground().equals(Color.black) && textField_55.getBackground().equals(Color.black) && textField_56.getBackground().equals(Color.black) && textField_57.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                		lblColoresSecretos.setVisible(true);
						layeredPane_1.setVisible(true);
						App.PrimeraJugada = true;
            	...
            	//ifelse columna 3	
	            	...
	            	if(textField_58.getBackground().equals(Color.black) && textField_59.getBackground().equals(Color.black) && textField_60.getBackground().equals(Color.black) && textField_61.getBackground().equals(Color.black) && textField_62.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                		lblColoresSecretos.setVisible(true);
						layeredPane_1.setVisible(true);
						App.PrimeraJugada = true;
            	...
            	//ifelse columna 4
	            	...
	            	if(textField_23.getBackground().equals(textField_4.getBackground())) {
	            		textField_63.setBackground(Color.black);
	            	}else {
	            		textField_63.setBackground(Color.white);
	            	}
	            	if(textField_24.getBackground().equals(textField_5.getBackground())) {
	            		textField_64.setBackground(Color.black);
	            	}else {
	            		textField_64.setBackground(Color.white);
	            	}
	            	if(textField_25.getBackground().equals(textField_6.getBackground())) {
	            	...
	            	if(textField_63.getBackground().equals(Color.black) && textField_64.getBackground().equals(Color.black) && textField_65.getBackground().equals(Color.black) && textField_66.getBackground().equals(Color.black) && textField_67.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                		lblColoresSecretos.setVisible(true);
						layeredPane_1.setVisible(true);
						App.PrimeraJugada = true;
            	...
            	//ifelse columna 5	
	            	...
	            	if(textField_68.getBackground().equals(Color.black) && textField_69.getBackground().equals(Color.black) && textField_70.getBackground().equals(Color.black) && textField_71.getBackground().equals(Color.black) && textField_72.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                		lblColoresSecretos.setVisible(true);
						layeredPane_1.setVisible(true);
						App.PrimeraJugada = true;
            	...
            	//ifelse columna 6	
	            	...
	            	if(textField_33.getBackground().equals(textField_4.getBackground())) {
	            		textField_73.setBackground(Color.black);
	            	}else {
	            		textField_73.setBackground(Color.white);
	            	}
	            	if(textField_34.getBackground().equals(textField_5.getBackground())) {
	            		textField_74.setBackground(Color.black);
	            	}else {
	            		textField_74.setBackground(Color.white);
	            	}
	            	if(textField_35.getBackground().equals(textField_6.getBackground())) {
	            		textField_75.setBackground(Color.black);
	            	}else {
	            		textField_75.setBackground(Color.white);
	            	}
	            	if(textField_36.getBackground().equals(textField_7.getBackground())) {
	            	...
	            	if(textField_73.getBackground().equals(Color.black) && textField_74.getBackground().equals(Color.black) && textField_75.getBackground().equals(Color.black) && textField_76.getBackground().equals(Color.black) && textField_77.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                		lblColoresSecretos.setVisible(true);
						layeredPane_1.setVisible(true);
						App.PrimeraJugada = true;
            	...
            	//ifelse columna 7	
	            	...
	            	if(textField_38.getBackground().equals(textField_4.getBackground())) {
	            		textField_78.setBackground(Color.black);
	            	}else {
	            		textField_78.setBackground(Color.white);
	            	}
	            	if(textField_39.getBackground().equals(textField_5.getBackground())) {
	            		textField_79.setBackground(Color.black);
	            	}else {
	            		textField_79.setBackground(Color.white);
	            	}
	            	if(textField_40.getBackground().equals(textField_6.getBackground())) {
	            		textField_80.setBackground(Color.black);
	            	}else {
	            		textField_80.setBackground(Color.white);
	            	}
	            	if(textField_41.getBackground().equals(textField_7.getBackground())) {
	            	...
	            	if(textField_78.getBackground().equals(Color.black) && textField_79.getBackground().equals(Color.black) && textField_80.getBackground().equals(Color.black) && textField_81.getBackground().equals(Color.black) && textField_82.getBackground().equals(Color.black)) {
                		JOptionPane.showMessageDialog(null, "Enhorabuena has ganado!");
                		lblColoresSecretos.setVisible(true);
						layeredPane_1.setVisible(true);
						App.PrimeraJugada = true;
            	...
            	//ifelse columna 8	
	            	...
	            	if(textField_43.getBackground().equals(textField_4.getBackground())) {
	            		textField_83.setBackground(Color.black);
	            	}else {
	            		textField_83.setBackground(Color.white);
	            	}
	            	if(textField_44.getBackground().equals(textField_5.getBackground())) {
	            		textField_84.setBackground(Color.black);
	            	}else {
	            		textField_84.setBackground(Color.white);
	            	}
	            	if(textField_45.getBackground().equals(textField_6.getBackground())) {
	            		textField_85.setBackground(Color.black);
	            	}else {
	            		textField_85.setBackground(Color.white);
	            	}
	            	if(textField_46.getBackground().equals(textField_7.getBackground())) {
	...
	//Creo un array de colores aleatorios 
	...
	//Utilizo el array anteriormente creado para rellenar los cuadrados de referencia, es decir, los cuadrados de solucion y los de disponibles
	public static void randomColors() {
		...
		textField_89.setBackground(colores[4]);
		
		Random r = new Random();
		textField_4.setBackground(colores[r.nextInt(5)]);
